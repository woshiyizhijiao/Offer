package com.wsyzj.android.offer.weiget;
...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArcWidth = ta.getDimensionPixelSize(R.styleable.CirclePercentView_arcWidth, 16);
        mPercentTextColor = ta.getColor(R.styleable.CirclePercentView_arcColor, 0xffffee00);
        mPercentTextSize = ta.getDimensionPixelSize(R.styleable.CirclePercentView_percentTextSize, 16);
        mRadius = ta.getDimensionPixelSize(R.styleable.CirclePercentView_radius, 100);
        ta.recycle();
